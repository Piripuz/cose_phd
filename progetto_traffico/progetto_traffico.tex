...
amounting to an annual economic loss comparable to 1.67\% of the state's GDP.
This figure describes the effect of a systemic inefficiency,
...
This solution however draw many, different challenges.
...
These junctions are called \textit{bottlenecks}.
...
Several studies extended their work.
Studies taking into account increasingly complex network topologies
include, for instance, \textcite{doi:10.1287/trsc.24.3.217, doi:10.1287/trsc.27.2.148, AKAMATSU2015808}

Similarly,
recent literature has increased the complexity of the population of users.
Notable examples of works considering non-homogenous users include \textcite{arnott1988schedule, amirgholy2017analytical}.
...
they anyway need to rely on a proper description of the population.
