...
minimizing a cost depending on some user-dependant parameters.
...
considering travellers to be \textit{inframarginal} is equivalent to assume their
parameters to follow some specific probability distributions.
Drawing from what done in \textcite{amirgholy2017analytical},
methods from statistics and portfolio theory can be employed to develop
a better knowledge of whether simple modifications to the users' preferences could lead to
...
\textcite{de2013random, doi:10.1177/0361198118792336} introduce uncertainty,
and study how risk-averse travellers behave in this case.
Different kinds of uncertainties can anyway be considered,
introducing noise at different levels,
leading to different models that can be studied analytically themselves.
